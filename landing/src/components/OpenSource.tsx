        ...
        <AnimatedSection delay={0.15}>
          <div className="bg-dc-sidebar rounded-lg border border-dc-divider p-8 sm:p-10 max-w-2xl mx-auto text-center">
            ...
            <p className="text-sm text-dc-text-muted leading-relaxed mb-8">
              ...
              entirely new features — the OCT codebase is yours to explore and extend.
            </p>

            <span className="inline-flex items-center gap-2.5 px-5 py-2.5 rounded-lg bg-dc-dark border border-dc-divider text-dc-text-muted font-medium text-sm">
              <Github size={16} />
