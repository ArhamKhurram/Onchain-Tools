...
import { LogIn, Key, Settings, Monitor } from 'lucide-react';
...
const steps = [
  {
    icon: LogIn,
    title: 'Sign In',
    desc: 'Create an OCT account and access the web console.',
    num: '01',
  },
  {
    icon: Key,
  ...
  },
  {
    icon: Settings,
    title: 'Configure',
    desc: 'Set up rooms, wallets, and caller alerts.',
    num: '03',
  },
  {
    icon: Monitor,
    title: 'Monitor',
    desc: 'Watch feed, wallets, and contracts in one dashboard.',
    num: '04',
  },
];
      ...
      <div className="mx-auto max-w-6xl">
        <AnimatedSection className="text-center mb-12">
          ...
          <p className="mt-3 text-dc-text-muted max-w-md mx-auto text-sm">
            From sign-up to monitoring in minutes — no install required.
          </p>
        </AnimatedSection>
        ...
        >
          ...
          {steps.map((step) => {
            ...
            return (
              ...
              >
                <div className="relative z-10 w-12 h-12 rounded-lg bg-dc-dark border border-oct-accent/20 flex items-center justify-center mb-4">
                  <Icon size={20} className="text-oct-accent" />
                </div>
