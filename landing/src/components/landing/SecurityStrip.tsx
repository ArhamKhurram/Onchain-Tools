...
export function SecurityStrip({ scrollRef }: { scrollRef: RefObject<HTMLElement | null> }) {
    ...
    >
      <div className="max-w-6xl mx-auto w-full">
        ...
        <motion.p
          ...
          whileInView={{ opacity: 1 }}
          viewport={{ once: true }}
          className="font-mono text-[10px] sm:text-xs text-black/85 mt-16 max-w-2xl leading-relaxed text-pretty pb-4"
        >
