...
import { APP_CONSOLE_PATH, appConsolePath } from '../../constants';
...
export function StackSection() {
  return (
    <section
      id="stack"
      className="relative snap-start snap-always min-h-screen flex flex-col bg-oct-flame text-black px-6 sm:px-10 py-20 sm:py-24"
    >
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-10 md:gap-8 flex-1">
          {pillars.map((p, i) => (
            ...
            >
              ...
              <p className="font-mono text-xs sm:text-sm leading-relaxed opacity-80 flex-1">{p.body}</p>
