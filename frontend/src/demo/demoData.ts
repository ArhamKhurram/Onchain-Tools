...
export const DEMO_CONFIG: AppConfig = {
  ...
  missedRunner: { enabled: false, minMultiplier: 1.5, lookbackHours: 24, cooldownHours: 24 },
...
const whaleMessages: FrontendMessage[] = [
  ...
  msg('m-w6', CH_TOKEN_DROPS, GUILD_DEGEN, 'token-drops', 'Degen Lounge', authors.mike, 'the whale tracking rooms in OCT are so useful ngl', minutesAgo(20), {
    reactions: [
      { emoji: { id: null, name: '💯' }, count: 3 },
    ],
  }),
